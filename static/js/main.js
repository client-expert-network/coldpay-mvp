        ...
        searchInput
          .typeahead(
...

            {
              ...
              templates: {
                header: '<h6 class="suggestions-header text-primary mb-0 mx-4 mt-3 pb-2">Services</h6>',
                suggestion: function ({ url, src, name, subtitle, meta }) {
                  return (
                    '<a href="' + url + '">' +
            ...
            },
            {
              ...
              templates: {
                header: '<h6 class="suggestions-header text-primary mb-0 mx-4 mt-3 pb-2">Users</h6>',
                suggestion: function ({ url, name, src, subtitle }) {
                  return (
                    '<a href="' + url + '">' +
                    '<div class="d-flex align-items-center">' +
                    '<img class="rounded-circle me-3" src="' + src + '" alt="' + name + '" height="32">' +
                    '<div class="user-info">' +
                    '<h6 class="mb-0">' + name + '</h6>' +
                    '<small class="text-muted">' + subtitle + '</small>' +
                    '</div>' +
